...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    twoFAEnabled: "2FA через Telegram включена",
    twoFADisabled: "2FA отключена",
    enable2FA: "Включить 2FA",
    disable2FA: "Отключить 2FA",
    get2FACode: "Получить код подтверждения",
    ...
    lottery: "Лотерея",
    lotteryTicket: "Билет лотереи",
    enterLottery: "Участвовать",
    ...
    guarantees: "Гарантии сделок",
    dealGuard: "Защита сделки",
    insurance: "Страховка",
  },
  en: {
    home: "Home",
    ...
    twoFAEnabled: "2FA via Telegram enabled",
    twoFADisabled: "2FA disabled",
    enable2FA: "Enable 2FA",
    disable2FA: "Disable 2FA",
    get2FACode: "Get verification code",
